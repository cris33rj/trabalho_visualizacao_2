...
<div class="grid grid-cols">
  <div id="ex01" class="card">
      O 12 acidentes mais comuns registrados pela PRF ano de <select name="CMBAno" id="CMBAno" onchange="${ vl.render(ex01(divWidth-150)) }">
...
<div class="grid grid-cols">
    <div id="ex20" class="card">
        ...
        <div style="width: 100%; margin-top: 15px;">
            ${ vl.render(ex20(divWidth-280,2021)) }
        </div>
        <h5>OBS: Ao posicionar o mouse sobre as regiões é possível avaliar os números.</h5>
    </div>
</div>
      ...
      "params":[
        {
          ...
          "bind": {"input": "select", "options": [null, 2021, 2022, 2023]}
        },
              {
          "name": "org2",
          "select": {"type": "point", "fields": ["ano"]},
