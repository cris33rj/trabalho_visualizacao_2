...
3) Sendo um país tropical, em que as temperaturas seguem uma tendência quase que absoluta acima daquelas propícias à formação de neve, há algum registro de acidente automobilístico registrado sob tal condição: neve?
4) Em qual período do dia há a incidência do maior e menor número de acidentes?

Para sanar as questões trazidas a baila, propusemos um gráfico em barras que reúne informações que permitem a apuração dos três primeiros questionamentos. Vejamos abaixo:
