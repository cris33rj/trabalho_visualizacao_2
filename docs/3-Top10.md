...
A explicação se dá pelo fato de artistas como **The Weekend** possuírem muitas músicas no conjunto analisado (22 músicas), e que se tiverem seus *streams* somados (aproximadamente 15.000.000.00), os colocam nas primeiras posições no histograma **A1**, enquanto que a outros artistas como **Milley Cyrrus**, primeira colocada no histograma **A2**, que só possui duas músicas que se somadas não alcançam um valor expressivo (no caso dela, as duas músicas totalizam 1.887.370.770), não figurando entre os dez artistas mais bem ranqueados pelo somatório de *streams*. Observe as diferenças no quadro **A3** ao lado: 
...
Para exemplificar, trouxemos abaixo, no histograma **A4**, as músicas dos dois artistas:
