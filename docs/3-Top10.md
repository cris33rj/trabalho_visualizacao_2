...
Sob outra ótica, **Miley Cyrrus**, possui a música **Flowers** lançada em 2023 com 1.316.855.716 em *streams*, enquanto que **The Weekend** não possui música lançada neste ano, o que reforça a explicação anterior. Veja a distribuição no quadro **A4**:

<div class="grid">
     <div id="ex09" class="card">
        <h4>Todas as músicas lançadas no ano pelos artistas The Weeknd e Miley Cyrus.</h4>
        <div style="width: 100%, margin-top: 15px;">
