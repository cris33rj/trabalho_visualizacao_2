...
<div class="grid grid-cols">
  <div id="ex02" class="card">
      ...
      <h5>OBS 1: Use os comandos acima para selecionar o ANO e a UNIDADE FEDERATIVA. Selecione "null" no campo ano para exibir os dados de todos os anos. </h5>
...
<div class="grid grid-cols">
    <div id="ex03" class="card">
      ...
      <h5>OBS: Filtre selecionando um ano, ou inclua todos selecionando "null".</h5>
    </div>
</div>

A colisão na traseira é o tipo de acidente mais frequênte se analisados os anos de **2021**, **2022**, **2023** e **2024***. Em seguida verificamos que saída de leito carroçável e colisão transversal ocorrem seguidamente nesta ordem.
...
<div class="grid grid-cols">
    <div id="ex04" class="card">
      ...
      <h5>OBS 1: Selecione o ano e/ou UNIDADE FEDERATIVA para filtrar os dados de plotagem. Selecione NULL para exibir os dados de todos Estados e anos numa mesma plotagem.</h5>
      <h5>OBS 2: Ao posicionar o mouse sobre as barras é possível avaliar algumas informações.</h5>      
    </div>
</div>
