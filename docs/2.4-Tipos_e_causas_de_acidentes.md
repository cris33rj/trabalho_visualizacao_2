...
O gráfico heatmap abaixo permite visualizar, sobre outro ângulo, a dimensão da diferença da quantidade de acidentes quando se comparada Minas Gerais, Paraná e Santa Catarina com os outros estados, principalmente nos acidentes do tipos "saída de leito carroçável" e "colisão traseira". 
<div class="grid grid-cols">
